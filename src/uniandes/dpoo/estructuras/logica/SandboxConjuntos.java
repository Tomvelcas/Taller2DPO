...
public class SandboxConjuntos
{
    ...
    {
    	List<String> list = new ArrayList <>(this.arbolCadenas);
        return list;
    }
    ...
    {
    	 List<String> siguienteCadena = new ArrayList<>();

    	    for (String i : arbolCadenas) {
    	        if (i.compareTo(cadena) >= 0) {
    	        	siguienteCadena.add(i);
    	        }
    	    }
    ...
    {
    	  List<String> elim = new ArrayList<>();
    	  for (String i : arbolCadenas ) {
    		  String x = i.toLowerCase();
    		  if( x.equals(cadena.toLowerCase())) {
    			  elim.add(i);
    		  }  		  
    	  }
    	  for (String j : elim) {
    		  arbolCadenas.remove(j);
    	  }
    ...
    public void volverMayusculas( )
    {
        ...
        for (String i : arbolCadenas) {
            nuevasCadenas.add(i.toUpperCase());
        }
        arbolCadenas.clear();
    ...
    {
        TreeSet<String> invert = new TreeSet<>(Collections.reverseOrder());
        invert.addAll(arbolCadenas);
        return invert;
    }
