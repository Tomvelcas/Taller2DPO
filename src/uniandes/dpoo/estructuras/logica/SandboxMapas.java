...
public class SandboxMapas
{
    ...
    {
    	List<String> primera = new ArrayList<>(mapaCadenas.keySet());
    	if (mapaCadenas.isEmpty()) {
            return null;
        }
         Collections.sort(primera);

        return primera.get(0);
    }
    ...
    {
    	List<String> ultima = new ArrayList<>(mapaCadenas.keySet());
    	if (mapaCadenas.isEmpty()) {
            return null;
        }
        Collections.sort(ultima);

        return ultima.get(ultima.size()-1);
    }
    ...
    {
    	Collection<String> mayusKey = new ArrayList<>();
        
        for (String llave : mapaCadenas.keySet()) {
            String llaveM = llave.toUpperCase();
            mayusKey.add(llaveM);
        }
    ...
    public void agregarCadena( String cadena )
    {
        ...
        if (!mapaCadenas.containsKey(Invertida)) {
    ...
    public void eliminarCadenaConValor( String valor )
    {
        ...
        for (Map.Entry<String, String> i : mapaCadenas.entrySet()) {
            if (i.getValue().equalsIgnoreCase(valor)) {
            	elim = i.getKey();
                break;
            }
        }
    ...
    public void reiniciarMapaCadenas( List<Object> objetos )
    {
        ...
        for (Object i : objetos) {
            ...
            mapaCadenas.put(palabra, palabra);
        }
    }
